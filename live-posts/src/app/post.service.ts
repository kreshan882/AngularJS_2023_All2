...
//normal class decorate with @Injectiable( for service) 
@Injectable({ providedIn: 'root' }) // initilise root service
export class PostService {

  //lisent some event , and do emit activity, someone can subscribe for automatic fetch data showeing 
  ...
  setPosts(listOfPosts: Post[]) {
    ...
    this.listChangedEvent.emit(listOfPosts);  //listOfPosts need to change everywhere,  post-list component can suscribe that
  }
}
